  ...
  try {
    ...
    const toResult = (
      ...
      return {
        ...
        // retain the upstream transient classification when no transport code is
        // present.
        errorCode: attempt.proc.errorCode ?? (transientUpstream ? "claude_transient_upstream" : null),
