...
Source before consolidation: `/Users/luke/.agents/skills/pinchtab`

---
name: pinchtab
disable-model-invocation: true
description: "Sub-skill of /browser-toolkit. Token-efficient browser automation via PinchTab using stable a11y refs (e5, e12 …) — clicks, forms, scraping, persistent-profile login, screenshot/PDF export. Loaded by /browser-toolkit; do not invoke directly."
metadata:
  openclaw:
    requires:
      bins:
