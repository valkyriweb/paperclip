...
export const help: Record<string, string> = {
  ...
  activeWindow: "Only fire heartbeats during a recurring weekly time window. Outside the window the timer is silently suppressed; on-demand wakes still work.",
  activeWindowTimezone: "IANA timezone the window is evaluated in, e.g. Africa/Johannesburg, Europe/London, UTC.",
  activeWindowDays: "Days of the week the window applies on.",
  activeWindowStart: "Local time the window opens (inclusive).",
  activeWindowEnd: "Local time the window closes (exclusive). Set earlier than the start time for a window that crosses midnight (e.g. 22:00 to 02:00).",
