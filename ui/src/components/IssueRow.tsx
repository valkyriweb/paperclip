...
export function IssueRow({
  ...
  const unreadDotButton = (
    <button
      ...
      className={cn(
        // Fork: enlarged hit target (h-7 w-7 with negative margins) so the
        // mark-read dot is comfortably clickable without shifting layout.
        "-m-1.5 inline-flex h-7 w-7 items-center justify-center rounded-full transition-colors",
