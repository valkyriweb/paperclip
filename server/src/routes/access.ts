    ...
    onboarding: {
      ...
      requiredFields: {
        ...
        agentDefaultsPayload:
          "Runtime-specific adapter config. OpenClaw Gateway agents must include url (ws:// or wss://) or transportProfile, plus headers.x-openclaw-token (or legacy x-openclaw-auth). Optional OpenClaw fields: paperclipApiUrl, waitTimeoutMs, sessionKeyStrategy, sessionKey, role, scopes, disableDeviceAuth, devicePrivateKeyPem. Other runtimes should include the config their adapter expects."
      },
